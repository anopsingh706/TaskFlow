 ...
 * GoogleSignInButton
 *
 * Opens the backend OAuth route directly. The backend's Passport middleware
 * then redirects the browser to Google. No fetch/axios needed — this is a
 * full-page navigation, not an API call.
 */
  ...
  return (
    <button
      ...
      className="w-full flex items-center justify-center gap-3 px-5 py-3 rounded-xl
                 ...
                 focus:outline-none focus:ring-2 focus:ring-violet-200 active:scale-[0.98]"
